<template>
  <NjSidebar v-bind="{ ...$props, ...$attrs }" :v-model:show="isOpenBurgerComp">
    ...
    <template #default>
      ...
      >
        <NjNavDropdownItem
          ...
          class="flex flex-col py-4 whitespace-nowrap cursor-pointer hover:text-gray-400 transition-colors duration-150"
        >
          <span class="relative z-700 flex h-full items-center">
            <span class="flex flex-col">
              <span class="flex flex-col items-center">
                <span class="block leading-none">{{ navItem.label }}</span>
              </span>
            </span>
          </span>
          <transition
